...
export const dict = {
  es: {
    ...
    about: {
      ...
      lead: "En ÜNOConsultores combinamos gestión del talento, desarrollo organizacional, asesoramiento especializado y tecnología para acompañar los desafíos de empresas en constante evolución. Trabajamos cerca de cada cliente, diseñando soluciones prácticas, sostenibles y adaptadas a su realidad.",
      ...
      founderRole: "CEO · ÜNOConsultores",
